      ...
      <div className="max-w-[1440px] m-auto px-6">
        <div className="flex justify-between items-center h-[80px]">
          ...
          <div className="hidden lg:block">
            <ul className='flex gap-x-10'>
              ...
              <li className='text-[18px] text-white font-medium hover:text-amber-600 duration-500 hover:font-bold cursor-pointer'>Services</li>
              <li className='text-[18px] text-white font-medium hover:text-amber-600 duration-500 hover:font-bold cursor-pointer'>Portfolio</li>
              <li className='text-[18px] text-white font-medium hover:text-amber-600 duration-500 hover:font-bold cursor-pointer'>Contact</li>
        ...
        <div className={`lg:hidden overflow-hidden transition-all duration-500 ${isOpen ? 'max-h-[500px] pb-6' : 'max-h-0'}`}>
          <ul className='flex flex-col gap-y-4'>
            ...
            <li className='text-[18px] text-white font-medium hover:text-amber-600 cursor-pointer'>Services</li>
            <li className='text-[18px] text-white font-medium hover:text-amber-600 cursor-pointer'>Portfolio</li>
            <li className='text-[18px] text-white font-medium hover:text-amber-600 cursor-pointer'>Contact</li>
